...
class VideoGenerator:
    ...
    def create_text_animation(self, text, duration=3, output_path='output.mp4'):
        ...
        for i in range(total_frames):
            ...
            animation_progress = i / total_frames
    ...
    def create_text_slideshow(self, texts, duration_per_text=2, output_path='output.mp4'):
        ...
        for idx, text in enumerate(texts):
            temp_path = f'static/videos/temp_{idx}_{datetime.now().timestamp()}.mp4'
    ...
    def create_custom_video(self, frames_data, output_path='output.mp4'):
        """Create custom video from frame data"""
        video_writer = cv2.VideoWriter(output_path, self.fourcc, self.fps, (self.width, self.height))
        ...
        for frame_data in frames_data:
            ...
            if 'text' in frame_data:
                ...
                position = frame_data.get('position', (self.width//2, self.height//2))
                font_scale = frame_data.get('font_scale', 1)
                color = frame_data.get('text_color', (255, 255, 255))
...
<head>
    ...
    <title>Flask Video Generator</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Create amazing videos with different effects and animations</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="generator-section">
                ...
                <form id="text-form">
                    <div class="form-group">
                        ...
                        <textarea name="text" rows="3" required placeholder="Enter your text here..."></textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="generator-section">
                ...
                <form id="slideshow-form">
                    <div class="form-group">
                        ...
                        <textarea name="texts" rows="5" required placeholder="Enter multiple lines of text..."></textarea>
                    </div>
                    <div class="form-group">
                        <label>Duration per text (seconds):</label>
                        <input type="number" name="duration" value="2" min="1" max="10">
                    </div>
            ...
            <div class="loading" id="loading">
                ...
                <p style="margin-top: 10px;">Generating your video...</p>
            </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Video Generated - Flask Video Generator</title>
    <style>
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
...
<body>
    <div class="container">
        ...
        <div class="buttons">
            <a href="{{ video_url }}" download class="btn">📥 Download Video</a>
